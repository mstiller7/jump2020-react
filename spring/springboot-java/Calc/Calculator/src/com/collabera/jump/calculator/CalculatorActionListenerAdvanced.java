...
public class CalculatorActionListenerAdvanced implements ActionListener {
	...
	public CalculatorActionListenerAdvanced(JTextField textField) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "+": {
			...
			String text = textField.getText();
			textField.setText("");
			System.out.println("RESET Text field");
			if (operator == null ) {
				...
				System.out.println("Else Value2" + value2);
			...
			if(!(previousOperator.equals(operator)))
			{
				textField.setText("");
			}
